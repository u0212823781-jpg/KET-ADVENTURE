...
Alex`,
    ...
    // ---------------- LISTENING ----------------
    {
      ...
      items: [
        ...
        { num: 3, question: 'What are they going to do first this afternoon?', options: { A: 'play a board game', B: 'go shopping', C: 'go cycling' }, correct: 'C', evidence: `Boy: "we'll play the game after the bike ride." — the bike ride comes first (they're already at the shops).` },
        { num: 4, question: 'What did the girl put on the pizza yesterday?', options: { A: 'onion and mushroom', B: 'tomatoes and mushroom', C: 'onion and tomatoes' }, correct: 'C', evidence: `Girl: "We didn't have any mushrooms left, so I used tomatoes with the onion instead." — onion and tomatoes, not mushroom (that's what the boy and his mum like).` },
        { num: 5, question: "Which girl is the boy's sister?", options: { A: 'long fair hair, glasses', B: 'short dark hair, glasses', C: 'long dark hair, no glasses' }, correct: 'B', evidence: `Boy: "she's got long hair but it's dark" and "my sister can't see well without them [glasses]!" — his sister has dark hair and wears glasses; the girl the friend saw had long blonde hair and no glasses, so it wasn't her.` },
      ],
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Jake's address: 51", num: 6, accepted: ['sherby'], suffix: 'Street', evidence: `Jake: "It's number 51, Sherby Street. You spell that S-H-E-R-B-Y."` },
        { label: 'Travel to Jake\u2019s house by:', num: 7, accepted: ['tram'], evidence: `Jake: "You can usually travel to my house by train, but the station nearest to my house is closed at the moment, so use the tram."` },
        { label: 'Time to arrive:', num: 8, accepted: ['1.45', 'quarter to two', '1/4 to 2', 'quarter to 2'], suffix: 'p.m.', evidence: `Jake: "get here at quarter to two." — quarter to two = 1:45.` },
        { label: "Bring: Jake's", num: 9, accepted: ['gloves'], evidence: `Jake: "Remember you borrowed my gloves... Can I have them back, please?" — bring the gloves; the hat can be kept.` },
        { label: "Jake's mum's phone number:", num: 10, accepted: ['05568 129437', '05568129437'], evidence: `Jake: "It's 05568 129437."` },
      ],
    ...
    },
    {
      ...
      items: [
        { num: 11, question: 'Who can take Emma and Jamie to the market?', options: { A: "Emma's mum", B: "Emma's neighbour", C: "Emma's cousin" }, correct: 'B', evidence: `Emma: "we can go with Annie, who lives next door." — Emma's mum is visiting her cousin, so the neighbour Annie takes them.` },
        { num: 12, question: 'When will they pick Jamie up?', options: { A: '10.15', B: '10.30', C: '10.45' }, correct: 'C', evidence: `Emma: "We'll come to your house at quarter to eleven, Jamie." — quarter to eleven = 10:45.` },
        { num: 13, question: 'What does Emma want to buy?', options: { A: 'jewellery', B: 'clothes', C: 'toys' }, correct: 'A', evidence: `Emma: "I need to find a necklace and earrings to wear with it." — she's borrowing the dress from Katie, but wants jewellery.` },
        { num: 14, question: 'Why does Jamie like the computer games on the market?', options: { A: "They're cheap.", B: "They're new.", C: "They're unusual." }, correct: 'C', evidence: `Jamie: "They're ones you can't get in other places. You can get new ones anywhere." — unusual/hard-to-find, not about price (they agree the old ones are "a little" expensive).` },
        { num: 15, question: 'Emma and Jamie agree that the Moon Café', options: { A: 'has friendly staff.', B: 'serves great food.', C: 'is very noisy.' }, correct: 'B', evidence: `Emma: "the burgers are fantastic." Jamie: "That's true!" — they agree on the food; Jamie thinks the music is loud (Emma disagrees) and that the waiters "never have time to chat" (Emma disagrees there too).` },
      ],
    ...
    },
    {
      ...
      type: 'listening-mc',
      items: [
        { num: 16, question: "You will hear two friends talking about a party. Why couldn't the girl go to it?", options: { A: 'She was feeling ill.', B: 'She needed to do her homework.', C: 'She had to look after her sister.' }, correct: 'C', evidence: `Girl: "Mum was working late so I had to give Annie her tea and a bath." — Annie is her baby sister; she wasn't ill, and homework came afterwards, on top of that.` },
        { num: 17, question: 'You will hear a teacher talking to a student called Danielle. What does he want Danielle to do?', options: { A: 'make her project longer than it is', B: 'try to finish her project earlier', C: 'change the subject of her project' }, correct: 'C', evidence: `Teacher: "I'd like you to choose something else to write about." — a different topic; the extra five days are just an option if she needs them.` },
        { num: 18, question: 'You will hear a boy talking to his friend about his new school bag. Why does he like his new bag?', options: { A: "It's made of leather.", B: "It's a good size.", C: "It's a bright colour." }, correct: 'B', evidence: `Boy: "Now I use my laptop, so I got one which was a better size for that." — the size suits his laptop; he even admits the colour "maybe... is too bright" and it's not leather (his old bag was).` },
        { num: 19, question: 'You will hear a father leaving a message for his daughter. Why is he phoning his daughter?', options: { A: 'to offer her a lift', B: 'to explain a problem to her', C: 'to ask her about some directions' }, correct: 'B', evidence: `Dad: "Sorry, I can't meet you from school this afternoon... You'll have to get the bus home." — he's explaining why he can't pick her up, since he's driving her brother back instead.` },
        { num: 20, question: 'You will hear a girl talking about going to her first surfing lesson. How is she feeling about it?', options: { A: 'upset that the weather might be bad', B: "worried she won't be very good", C: "sorry that her friend can't go" }, correct: 'B', evidence: `Girl: "what if everyone's better than me — I don't want to feel embarrassed." — worried about her own ability; the weather/waves and her friend not coming don't bother her ("That's no problem").` },
      ],
    ...
    },
    {
      ...
      items: [
        { num: 21, person: 'Sofia', correct: 'B', evidence: `Carlos: "it's the basketball team she plays for." — even though Granny thought hockey would suit her.` },
        { num: 22, person: 'Aidan', correct: 'G', evidence: `Carlos: "He's bought a racket and loves using that." — tennis, even though he's tall enough for basketball (which is full anyway).` },
        { num: 23, person: 'Tina', correct: 'F', evidence: `Carlos: "she loves being in the pool. She wins lots of races." — swimming; the bike is just how Granny sometimes sees her.` },
        { num: 24, person: 'Nick', correct: 'H', evidence: `Carlos: "The sports teacher wanted him to join the hockey team, but he prefers volleyball!"` },
        { num: 25, person: 'Katrina', correct: 'C', evidence: `Carlos: "She joined a new team called 'Fast wheels'!... she goes everywhere by bike." — cycling; she wanted basketball too but has no time for it.` },
      ],
