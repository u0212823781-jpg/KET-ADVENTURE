...
Alex`,
    ...
    // ---------------- LISTENING ----------------
    {
      ...
      items: [
        ...
        { num: 3, question: 'Where will the friends go first?', options: { A: 'a shop', B: 'a café', C: 'a library' }, correct: 'A', evidence: `Bella: "before that I've got to collect my new glasses from the shop." — the shop comes before the café or the library.` },
        { num: 4, question: 'How does the girl get to school now?', options: { A: 'by bus', B: 'by bike', C: 'on foot' }, correct: 'C', evidence: `Amy: "I've started leaving home early and walking there." — she now walks, even though the bike is normally good exercise and the bus was too noisy.` },
        { num: 5, question: 'What do they decide to buy for their mother?', options: { A: 'a necklace', B: 'earrings', C: 'a bracelet' }, correct: 'B', evidence: `Girl: "I saw some nice silver earrings at the market." Boy: "Let's get what you suggested." — they agree on the earrings, not another necklace or a bracelet.` },
      ],
    ...
    },
    {
      ...
      rows: [
        ...
        { label: 'Take:', num: 6, accepted: ['kite'], evidence: `Mandy: "I wanted to take my guitar but Mum says no — so bring your kite instead please."` },
        { label: 'Place for lunch:', num: 7, accepted: ['park'], evidence: `Mandy: "My mum doesn't like eating on the beach but there's a park. We'll eat there..."` },
        { label: 'Sport we\u2019ll play:', num: 8, accepted: ['volleyball'], evidence: `Mandy: "This time I've booked for us to play volleyball! It'll be fun."` },
        { label: 'Cost of boat trip on Sunday: £', num: 9, accepted: ['3.75', 'three pounds seventy five', 'three pounds seventy-five'], suffix: 'each', evidence: `Mandy: "A ticket is usually four pounds fifty, but there's a discount on Sunday and it's only three seventy-five."` },
        { label: 'Arrive at Mandy\u2019s home at:', num: 10, accepted: ['six thirty', '18:30', '6:30'], suffix: 'p.m.', evidence: `Mandy: "We'll leave the beach at quarter past five. Then we'll be back at my place at six thirty..."` },
      ],
    ...
    },
    {
      ...
      items: [
        { num: 11, question: 'When did they meet each other for the first time?', options: { A: 'on the way to school', B: 'in a lesson', C: 'in the lunch break' }, correct: 'B', evidence: `Ned: "I'm so happy we sat next to each other in our first class, Aisha." — they met in a lesson, even though they live in the same street.` },
        { num: 12, question: 'How did Ned feel before he started the new school?', options: { A: 'scared', B: 'excited', C: 'lucky' }, correct: 'B', evidence: `Aisha: "I felt excited actually." Ned: "Me too. Not scared at all."` },
        { num: 13, question: 'Ned and Aisha agree that', options: { A: 'the teachers are very kind.', B: 'their classmates are all very nice.', C: 'the school building is very attractive.' }, correct: 'A', evidence: `Aisha: "I like all our teachers. They do lots to help us." Ned: "That's true." — the building "doesn't look great" and not everyone in the class is lovely, so B and C don't fit.` },
        { num: 14, question: "Which lesson doesn't Aisha like much?", options: { A: 'geography', B: 'maths', C: 'history' }, correct: 'C', evidence: `Aisha: "geography's my favourite now. History's the only subject I don't enjoy much."` },
        { num: 15, question: 'What do they both say about homework at the new school?', options: { A: 'They got less in their old schools.', B: 'It takes a long time to do.', C: 'Some of it is quite easy.' }, correct: 'A', evidence: `Ned: "we didn't get so much in my old school." Aisha: "We got very little at mine as well." — they agree they get more homework now than before.` },
      ],
    ...
    },
    {
      ...
      type: 'listening-mc',
      items: [
        { num: 16, question: 'You will hear two friends talking about a book. How did the boy get the book?', options: { A: 'He borrowed it from a family member.', B: 'He won it in a sports event.', C: 'He bought it in a shop.' }, correct: 'B', evidence: `Boy: "I was really pleased when it was given to me as a prize yesterday. I was first in the running race!" — he won it; he didn't have enough money to buy it, and he'll lend it to his cousin later, not the other way round.` },
        { num: 17, question: 'You will hear a girl talking to her father about a lesson. What type of lesson did she have?', options: { A: 'a guitar lesson', B: 'a tennis lesson', C: 'a dance lesson' }, correct: 'A', evidence: `Girl: "the way you hold an instrument is important..." "My fingers really hurt afterwards!" — an instrument lesson (guitar), not tennis or dance.` },
        { num: 18, question: 'You will hear a boy telling his friend about his next holiday. Where will the boy stay on holiday?', options: { A: 'in a house', B: 'in a hotel', C: 'in a tent' }, correct: 'C', evidence: `Boy: "there are so many of us visiting her this summer that I'll have to camp in her garden." — he'll camp (a tent), not stay in the house or a hotel.` },
        { num: 19, question: 'You will hear a teacher talking to his class. What does he want his class to do now?', options: { A: 'start some maths problems', B: 'talk about their new textbook', C: 'check an exercise in pairs' }, correct: 'C', evidence: `Teacher: "I'd like you to work with a partner and compare what you wrote." — checking their maths answers together, before discussing as a class and starting a new section.` },
        { num: 20, question: 'You will hear two friends talking about their plans for Saturday. What are they going to do together on Saturday?', options: { A: 'have a cycle ride', B: 'cook some special food', C: 'go for a walk' }, correct: 'C', evidence: `Boy: "We're going to have a walk in the forest with my mum. Would you like to join us for that on Saturday?" Girl: "Brilliant..." — they'll walk together; she cycles there herself, and dinner comes after.` },
      ],
    ...
    },
    {
      ...
      items: [
        { num: 21, person: 'Sally', correct: 'H', evidence: `Boy: "she loves history — she's going to show people our town and tell them about it." — a tour guide.` },
        { num: 22, person: 'Peter', correct: 'E', evidence: `Mum: "Is he going to help his dad look after all their animals?" Boy: "That's right" — Peter will be a farmer; cooking is just something he loves doing.` },
        { num: 23, person: 'Amy', correct: 'G', evidence: `Boy: "she really wants to help children learn how to dance." — teaching, despite being good at guitar.` },
        { num: 24, person: 'Tom', correct: 'B', evidence: `Boy: "loves being in the kitchen. He hopes to make the meals in a hotel." — a chef, even though he plays piano well.` },
        { num: 25, person: 'Jane', correct: 'C', evidence: `Boy: "she'd like to spend all day looking at people's teeth!" — a dentist, not a doctor.` },
      ],
